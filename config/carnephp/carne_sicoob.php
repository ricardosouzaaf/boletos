...
$IdDoSeuSistemaAutoIncremento = $campo['boleto']; 
...
$dadosboleto["conta"] = $conta; // Num da conta, sem digito
			...
			// DADOS PERSONALIZADOS - SICOOB
$dadosboleto["convenio"] = $convenio; // 7 digitos
...
//agencia e sempre 4 digitos
$agencia = formata_numero($dadosboleto["agencia"],4,0);
//conta e sempre 8 digitos
...
// Nosso numero de ate 8 digitos - 2 digitos para o ano e outros 6 numeros sequencias por ano 
...
VALUES('$id_cliente','$codigo','$idpedido','$linha_digitavel','$data_vencimento','$cedente','$agencia_codigo','$data_documento','$numero_documento','$especie_doc','$aceite','$data_processamento','$nosso_numero','$carteira','$especie','$quantidade','$valor_unitario','$valor_boleto','$instrucoes1','$instrucoes2','$sacado','$endereco1','$endereco2','$codigo_barras','SICOOB','$numero_documento_rec','N')") or die (mysql_error());
...
header("Location: cn_sicoob.php?cliente=$idcv&pedido=$idpd");
