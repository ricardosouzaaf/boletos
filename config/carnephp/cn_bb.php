...
$ver = mysql_query("SELECT * FROM carnes WHERE id_cliente = '$idcliente' AND fatura = '$idpedido' AND situacao = 'N' AND banco = 'BB' order by data_vencimento ASC") or print (mysql_error());
...
<table>
  ...
  <table class="tabelas" style="width:195px; border-left:solid; border-left-width:2px; border-left-color:#000000;" border="0" cellspacing="0" cellpadding="0">
    <tr>
    <td style="width:150px;"><img src="imagens/logobb.jpg" alt="Banco do Brasil" width="100" height="30" title="caixa" /></td>
  ...
  <table border="0" cellpadding="0" cellspacing="0" id="tb_logo">
    <tr>
      <td rowspan="2" valign="bottom" style="width:150px;"><img src="imagens/logobb.jpg" alt="Banco do Brasil" width="150" height="40" title="caixa" /></td>
